...
class LanguageController extends Controller
{
    ...
    public function index()
    {
        ...
        $data['languagesImgPath']  = 'distuploads/flags';
    ...
    public function store(Request $request)
    {
        ...
        if (! is_writable(base_path('resources/lang/')) || ! is_writable(base_path('distjs/lang/'))) {
    ...
    public function edit(Request $request)
    {
        if (! empty($request->id)) {
            ...
            $return_lang['flag'] = url('distdatta-able/fonts/flag/flags/4x3/' . getSVGFlag($language->short_name) . '.svg');
