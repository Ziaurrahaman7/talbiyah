<div class="hover:shadow-md border bg-white rounded layout relative pb-10">
    <div class="border-gray-600">
        <div class="relative group">
            @if (array_key_exists($item->id, $itemFiles) && file_exists('distuploads/items/'. $itemFiles[$item->id]))
                <img src="{{ asset('distuploads/items/'. $itemFiles[$item->id]) }}" alt="{{ __('Image') }}" class="w-full h-44 sm:h-60" />
            @else
